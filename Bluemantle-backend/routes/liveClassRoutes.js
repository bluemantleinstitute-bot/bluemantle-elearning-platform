...
const { scheduleClass, getAllClasses, getClassById, getTeacherClasses, getBatchClasses, getMyClasses, joinLive, watchRecording, updateStatus, finishLiveClass, reigniteLiveClass, updateClass, deleteClass, syncZoomAttendance, syncCloudRecording, streamCloudRecording } = require("../controllers/liveClassController");
...
router.get("/:id/recording-stream", authMiddleware, streamCloudRecording);
